...
def generate_launch_description():
    ...
    # Xacro path
    urdf_dir = get_package_share_path('simulation') / 'urdf' / 'SQUAREROBOT' / 'Robot.xacro'
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(bringup_dir, 'world', 'SIM2024RMUC', 'SIM2024RMUC.world'),
    ...
    start_rviz_cmd = Node(
            ...
            executable='rviz2',
            name='rviz2',
            arguments=['-d' + os.path.join(bringup_dir, 'rviz', 'mid_360.rviz')]
    )
