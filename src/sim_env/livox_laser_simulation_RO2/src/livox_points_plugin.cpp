...
namespace gazebo
{
    ...
    void LivoxPointsPlugin::Load(gazebo::sensors::SensorPtr _parent, sdf::ElementPtr sdf)
    {
        ...
        RCLCPP_INFO(rclcpp::get_logger("LivoxPointsPlugin"), "scan info size: %d", aviaInfos.size());
        ...
        RCLCPP_INFO(rclcpp::get_logger("LivoxPointsPlugin"), "sample: %d", samplesStep);
        RCLCPP_INFO(rclcpp::get_logger("LivoxPointsPlugin"), "downsample: %d", downSample);
